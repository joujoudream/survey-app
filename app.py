...
if 'show_full_blue_view' not in st.session_state: st.session_state.show_full_blue_view = False
...
with col2:
    ...
    if st.session_state.show_full_blue_view:
        ...
        st.markdown(
            f"""
            <div class='blue-total-fullwidth'>
                <div class='blue-total-fullwidth-title'>TOTAL PROPERTY COUNT IN FILE 📱</div>
                <div class='blue-total-fullwidth-value'>{total_count}</div>
            </div>
            """, 
