...
with col2:
    ...
    # معالجة الضغط على Enter أو زر الحفظ (تم إصلاح المحاذاة هنا)
    if submitted or btn_save_manual:
        ...
        # 🔹 الحالة 2: الضغط على Enter بعد إدخال رقم العقار
            ...
            if is_duplicate:
                ...
                # الاحتفاظ بالاسم والتوجيه مع تحديده للبدء المباشر أو الانتقال
                st.session_state.region_input_val = region_val
                st.session_state.prop_input_val = ""
                ...
                # الاحتفاظ باسم المنطقة وتفريغ العقار والتوجيه لاسم المنطقة وتحديده
                st.session_state.region_input_val = region_val
                st.session_state.prop_input_val = ""
                st.session_state.focus_field = "region"
